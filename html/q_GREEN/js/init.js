...
//		$(window).resize(function(){
//			if ($(this).width() < 720){
//				$('.service_l').removeClass('cbp-so-side cbp-so-side-left');
//				$('.service_r').removeClass('cbp-so-side cbp-so-side-left');
//				$('.services_cont_slider').removeClass('cbp-so-section cbp-so-init cbp-so-animate');
//			}
//		});
		/**
		 *  counters
